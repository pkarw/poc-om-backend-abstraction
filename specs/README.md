...
| 11 | [Testbench](11-testbench.md) | `TESTBENCH` | Running a *real* upstream Open Mercato against a port: shared DB (upstream owns schema), migrations-off port, ported-module-driven reverse-proxy seam, shared JWT secret + lookup-hash pepper, honest placeholder-data rule |
