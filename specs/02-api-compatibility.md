...
| `makeCrudRoute` (`packages/shared/src/lib/crud/factory.ts`) | Shared CRUD endpoint factory/base-class producing the list/create/update/delete contract of R19–R43 |
